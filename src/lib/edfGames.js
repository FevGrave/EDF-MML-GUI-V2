...
// (2026-09). EDF 6 also has an Epic Games Store release (`epicApp`); if a game's
// platform is set to "epic" in Settings, the Play page launches via
// com.epicgames.launcher://apps/<epicApp>. EDF 6.2 is not on PC yet (PS5-first;
// PC release expected later) and is therefore not listed here.
//
// `engine`: the game engine each title runs on.
//   - LibXGS: Sandlot mainline titles (4.1, 5, 6)
...
export const EDF_GAMES = [
  { id: "edf41", appid: "251110", title: "EARTH DEFENSE FORCE 4.1 The Shadow of New Despair", engine: "LibXGS" },
  { id: "wingdiver", appid: "574200", title: "EARTH DEFENSE FORCE 4.1 WINGDIVER THE SHOOTER", engine: "Unity" },
  { id: "edf5", appid: "1039840", title: "EARTH DEFENSE FORCE 5", engine: "LibXGS" },
  { id: "edf6", appid: "2291060", title: "EARTH DEFENSE FORCE 6", engine: "LibXGS", epicApp: "earth-defense-force-6-129839" },
